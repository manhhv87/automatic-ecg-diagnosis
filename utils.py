...
def generate_table(y_true, score_fun, diagnosis, y_neuralnet, y_cardio, y_emerg, y_student):
    scores_list = []
...
def plot_confusion_matrix(y_true, nclasses, diagnosis, y_neuralnet, y_cardio, y_emerg, y_student):
